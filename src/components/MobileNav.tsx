...
export default function MobileNav({
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 z-[200] h-16 bg-[#0f0f11]/95 backdrop-blur-xl border-t border-white/5 flex items-center justify-around px-1 selection:bg-transparent safe-bottom">
