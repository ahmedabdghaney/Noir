...
// بعض الأسماء (نتفلكس، HBO، أمازون) إلها id ثنائي مختلف بين الاثنين، فنخزن الاثنين إذا توفر.
...
export interface Studio {
  ...
  color: string;            // لون الخلفية (هوية الشركة) — احتياطي إذا الشعار ما تحمّل
}

// منصات البث الكبرى أولاً (آبل، نتفلكس، أمازون)، وبعدين شركات الإنتاج
export const STUDIOS: Studio[] = [
  ...
  { key: 'amazon',    title: 'أمازون برايم',  companyId: 20580,  networkId: 1024, color: '#0d2538' },
